            ...
            <div className="row justify-content-center cards ">
                ...
                <div className="col-lg-4 col-md-12 d-flex card flex-column">
                    <div className="card-body">
                        ...
                        <a href="https://raw.githubusercontent.com/LuaPixel/Portif-lio-react/refs/heads/master/src/uber.png" className="btn verImagem" target="_blank" rel="noopener noreferrer" >Ver Imagem</a>
                    </div>
                </div>
                
                <div className="col-lg-4 col-md-12 d-flex card ">
                    <div className="card-body ">
                        <img src={tail} className="cardImg d-flex col-lg-12 col-md-12" alt="Header uber"/>
                        ...
                        <a href="https://raw.githubusercontent.com/LuaPixel/Portif-lio-react/refs/heads/master/src/tail.png" className="btn verImagem" target="_blank" rel="noopener noreferrer">Ver Imagem</a>
                    </div>
                </div>
            </div>
