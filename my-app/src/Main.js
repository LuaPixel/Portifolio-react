...
export default function Main(){
    ...
    <main className="d-flex bg-black w-100 min-vh-100 mx-auto">
        <div className=" luana d-flex flex-column gap-3 text-white col-sm-12 col-md-12 ">
            <h1 className="code mb-3 text-sm-center"> &lt; Luana<br />Bento / &gt;</h1>

            <h3 className="desen mb-4 text-sm-center">Desenvolvedora Front-end</h3>
            ...
            <button onClick={handleClick} alt="Contato" className="work d-flex flex-column mx-auto" target="_blank"> Transforme Suas Ideias em Realidade <br/>   — Fale Comigo </button>

            
            
        </div>

        <div className="ilusImg col-md-12 col-sm-12 col-lg-6 d-flex" >
            <img src={ilus} className="ilus img-fluid d-flex" alt="foto com hover"/>
        </div>
